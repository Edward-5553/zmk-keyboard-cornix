...
- Use a 64×128 portrait layout. Connection icons are at the top, followed by
  fixed L/R battery rows, a centered 32×32 cat, layer name, locks and modifiers.
...
idle deadline, long layer names, modifiers, display wake and no stale pixels.
